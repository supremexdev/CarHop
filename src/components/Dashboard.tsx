  ...
  return (
    <div className="py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Quick Actions */}
        <div className="bg-gradient-to-r from-primary to-orange-600 text-white rounded-xl p-8 shadow-lg">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <button className="px-8 py-3 bg-[#f6f8ef] text-primary border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors shadow-lg">
                Browse Cars
              </button>
            </div>
